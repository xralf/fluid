...
COMPILER_DIR           := cmd/fluidc
ENGINE_DIR             := cmd/fluid
...
COMPILER               := $(COMPILER_DIR)/fluidc
ENGINE                 := $(ENGINE_DIR)/fluid
...
#build_ralftest: clean prepare build_compiler build_engine
#build_ralftest: clean prepare
